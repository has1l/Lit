...
const STEPS = [
  ...
  },
  {
    ...
    title: 'Рабочий день',
    text: 'Отсюда сотрудник начинает день, отмечает выполненные задачи и завершает смену с отчётом.',
  },
  {
    page: 'goals',
    target: 'employee-nav-goals',
    title: 'Цели',
    text: 'Здесь виден план задач на месяц, назначенный руководителем.',
  },
  {
    page: 'store',
    target: 'employee-nav-store',
    title: 'Магазин',
    text: 'Здесь можно обменять заработанные баллы на доступные награды и отслеживать заявки.',
  },
  {
    page: 'chat',
